...
/// `docs/state-schema.md`, "Waived and excluded": 16 rows marked `waived:`.
...
mod tests {
    ...
    fn projection_is_never_compared() {
        ...
        assert_eq!(
            ...
            // discr-st8 (Part 12/round) added discs_out/disc_cap per player,
            // so 8 per player rather than 6.
            1 + 2 * 8 + DISC_SLOTS * 9 + TILE_CELLS * 2,
